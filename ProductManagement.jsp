...
<body>
<spring:url value="/category/add" var="productActionUrl" />
	<form:form class="form-horizontal" method="post" name = "productList" modelAttribute="produtM" action="${productActionUrl}">
<nav class="navbar navbar-default">
	  <div class="container-fluid">
	    <div class="navbar-header">
	    <spring:url value="/login/add" var="urlHome" />
...
<table class="table table-striped" id= "dynamictable">	
		...
		<spring:bind path="productName">
			<div class="form-group ${status.error ? 'has-error' : ''}">
				...
				<div class="col-sm-10">
					<form:input path="productName" type="text" class="form-control " id="productName{i.index}" placeholder="productName " />
