...
<body>
<!-- Url to the controller to map the post request -->
<spring:url value="/item/add" var="itemActionUrl" />
...
<!-- Fields of the form -->
		...
		<spring:bind path="EXD">
			<div class="form-group ${status.error ? 'has-error' : ''}">
				<label class="col-sm-2 control-label"> EXD :
				</label>
				<div class="col-sm-10">
					<form:input path="EXD" type="text" class="form-control " id="EXD" placeholder="EXD " />
					<form:errors path="EXD" class="control-label" />
				</div>
			</div>
		</spring:bind>
		
		<spring:bind path="MFD">
			<div class="form-group ${status.error ? 'has-error' : ''}">
				<label class="col-sm-2 control-label"> MFD :
				</label>
				<div class="col-sm-10">
					<form:input path="MFD" type="text" class="form-control " id="MFD" placeholder="MFD " />
					<form:errors path="MFD" class="control-label" />
				</div>
			</div>
		</spring:bind>
