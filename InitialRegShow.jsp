...
<meta charset="utf-8">
  ...
  <l
  ink href="${pageContext.request.contextPath}/vendor/fontawesome-free/css/all.min.css" rel="stylesheet">
...
<body>
    ...
    <div class="container">
      <a class="navbar-brand" href="/PharmacySystem/"> GO TO LOGIN PAGE ...AFTER GETTING ACCESS , USE YOUR LOGIN DEATILS </a>
    ...
    <h2>Deatails were Successfully saved ....!!!!!!!! ... </h2>
	<div class="row">
