...
<spring:url value="/reg/add" var="regActionUrl" />

	<form:form class="form-horizontal" method="post" name="registrationForm" 
	 modelAttribute="regForm" action="${regActionUrl}" >
		...
		<spring:bind path="orgName">
			<div class="form-group ${status.error ? 'has-error' : ''}">
				<label class="col-sm-2 control-label">OrgName :
				</label>
				<div class="col-sm-10">
					<form:input path="orgName" type="text" class="form-control " id="orgName" placeholder="orgName " />
					<form:errors path="orgName" class="control-label" />
				</div>
			</div>
		</spring:bind>
		...
		<spring:bind path="contactNo">
			<div class="form-group ${status.error ? 'has-error' : ''}">
				<label class="col-sm-2 control-label">ContactNo :
				</label>
				<div class="col-sm-10">
					<form:input path="contactNo" type="text" class="form-control " id="contactNo" placeholder="contactNo " />
					<form:errors path="contactNo" class="control-label" />
				</div>
			</div>
		</spring:bind>
...
<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10">
					...
					<!--<button type="submit" class="btn-lg btn-primary pull-right" onclick="validateSubmitForm();">Add</button>  -->	
						<input type="button" name="Submit" value="submit"class="btn-lg btn-primary pull-right" onclick="validateSubmitForm();"/> 
